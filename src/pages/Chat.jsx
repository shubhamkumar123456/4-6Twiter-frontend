...
const Chat = () => {
  const Endpoint = "https://twitter-ds6j.onrender.com"
  ...
  async function getChat() {
    let res = await axios.get(`https://twitter-ds6j.onrender.com/message/getMessage/${friend._id}`, {
      headers: {
        'Authorization': token
      }
    })
  ...
  const handleSendMessage = async () => {
    ...
    let res = await axios.post(`https://twitter-ds6j.onrender.com/message/send/${friend._id}`, { text: currentMessage }, {
      headers: {
        'Authorization': token
      }
    })
